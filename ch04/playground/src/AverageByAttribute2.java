...
public class AverageByAttribute2 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		JobConf job = new JobConf(conf, AverageByAttribute2.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new AverageByAttribute2(), args);
